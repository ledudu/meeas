<?php 
	...
	if (isset($_GET['page']) && $_GET['page'] == 'e-admin.php') {
		...
		wp_enqueue_script('adminjquery', 'http://cdn.bootcss.com/jquery/1.10.2/jquery.min.js', false, '1.0.0', false);
    ...
    foreach($select as $sel){
     ...
     switch($sel){
	  ...
	  case 'logo':
	    ...
	    break;
	  case 'statement':
        $option = '本主题基于MIT开源协议免费开放使用，作者仅保留著作版权。使用本主题可进行任意形式修改，但请保留作者版权。';
	    break;
	  case 'copy':
        $option = ' 基于 <a href="https://cn.wordpress.org/" target="_blank" rel="nofollow">WordPress</a> & <a href="http://www.asuper.com.cn"  title="阿超博客">阿超</a>';
	    break;
	  case 'sign':
	  ...
	  case 'tongji':
	    ...
	    break;
	  case 'foot_link':
	    $option = '<li><a href="http://www.my-eclipse.cn">MyEclipse中文网</a></li>
       <li><a href="http://blog.my-eclipse.cn">Eclipse部落</a></li>
       <li><a href="http://www.asuper.com.cn">阿超博客</a></li>';
	    break;
	  case 'category':
	  	$option = '1';
	    break;
	  case 'new':
        $option = array(
           '0' => '跑车',
           '1' => '随着国内汽车市场的多元化,更多强调个性的车型开始进入市场,其中较为普遍的就是各类厂商标榜的“运动轿跑车”,这类车型采用流畅的溜背造型,动感十足',
           '2' => 'http://meeas.asuper.com.cn',
           '3' => get_bloginfo('template_directory').'/images/content/1.jpg',
           '4' => '大海',
           '5' => '大海是一匹勇猛的骏马 一路嚎叫 一路奔跑;大海是一群不规则的山脉 高低起伏，连绵不断 山谷处处，河流千万 nbsp;大海是广阔的草原 有时是绿草遮绵羊 有时是牧民的好家',
           '6' => 'http://meeas.asuper.com.cn',
           '7' => get_bloginfo('template_directory').'/images/content/2.jpg',
           '8' => '花',
           '9' => '典型的花,在一个有限生长的短轴上,着生花萼、花瓣和产生生殖细胞的雄蕊与雌蕊。',
           '10' => 'http://meeas.asuper.com.cn',
           '11' => get_bloginfo('template_directory').'/images/content/3.jpg',
           '12' => '风景',
           '13' => '总是觉得一个美人和一个美景在遭遇上有很多相同和类似的地方。于是试着来将这些相同之处来作些描述，算是自娱吧。美人分很多类型，有外表上一眼就见到的美，有从内散发出来的美',
           '14' => 'http://meeas.asuper.com.cn',
    ...
    function enews_function(){   
        add_theme_page( 'Meeas主题设置', 'Meeas主题设置', 'edit_themes',basename(__FILE__), 'content_function');   
    }   
    ...
    <div class="main">
    	<div class="cats">
	 	...
	 	<div class="h">
		  	...
		  	<div class="hr">
		   		<a href="http://meeas.asuper.com.cn" target="_blank">+ 技术支持</a>
		  	</div>
	 	</div>
	<div class="n">
	   <div class="hd">
