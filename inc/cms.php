...
?>
  <div class="<?php if($key%2==0){echo 'span6 home-reviews no-margin-left';}else{ echo 'span6 home-reviews';}?>">
    ...
    <div class="item"> <a href="<?php the_permalink() ?>">
      <figure> <img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo catch_first_image(); ?>&h=65&w=90&zc=1" alt="<?php the_title(); ?>" class="thumbnail"/> </figure>
      </a>
      <div class="content">
